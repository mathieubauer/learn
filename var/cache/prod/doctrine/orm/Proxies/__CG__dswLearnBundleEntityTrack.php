 ...
 */
class Track extends \dsw\LearnBundle\Entity\Track implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Track' . "\0" . 'id', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Track' . "\0" . 'date', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Track' . "\0" . 'user', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Track' . "\0" . 'module'];
        }
