 ...
 */
class Texte extends \dsw\EvalBundle\Entity\Texte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Texte' . "\0" . 'id', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Texte' . "\0" . 'reponse', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Texte' . "\0" . 'user', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Texte' . "\0" . 'evaluation'];
        }
