 ...
 */
class Questionnaire extends \dsw\QuizBundle\Entity\Questionnaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Questionnaire' . "\0" . 'id', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Questionnaire' . "\0" . 'titre', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Questionnaire' . "\0" . 'code', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Questionnaire' . "\0" . 'intro', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Questionnaire' . "\0" . 'user', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Questionnaire' . "\0" . 'questions', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Questionnaire' . "\0" . 'dateCrea'];
        }
