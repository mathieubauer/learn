...
namespace Proxies\__CG__\dsw\QuizBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Answer extends \dsw\QuizBundle\Entity\Answer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Answer' . "\0" . 'id', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Answer' . "\0" . 'answer', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Answer' . "\0" . 'feedback', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Answer' . "\0" . 'score', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Answer' . "\0" . 'axe', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Answer' . "\0" . 'question', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Answer' . "\0" . 'attempts'];
        }
    ...
    public function addAttempt(\dsw\QuizBundle\Entity\Attempt $attempt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAttempt', [$attempt]);

        return parent::addAttempt($attempt);
    }
    ...
    public function removeAttempt(\dsw\QuizBundle\Entity\Attempt $attempt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAttempt', [$attempt]);

        return parent::removeAttempt($attempt);
    }
    ...
    public function setAxe($axe)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAxe', [$axe]);
    ...
    public function getAxe()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAxe', []);
