 ...
 */
class Enregistrement extends \dsw\EvalBundle\Entity\Enregistrement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Enregistrement' . "\0" . 'id', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Enregistrement' . "\0" . 'records'];
        }
