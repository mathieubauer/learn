 ...
 */
class Question extends \dsw\QuizBundle\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Question' . "\0" . 'id', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Question' . "\0" . 'intitule', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Question' . "\0" . 'questionnaire', '' . "\0" . 'dsw\\QuizBundle\\Entity\\Question' . "\0" . 'answers'];
        }
    ...
    public function setQuestionnaire(\dsw\QuizBundle\Entity\Questionnaire $questionnaire)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setQuestionnaire', [$questionnaire]);
    ...
    public function getQuestionnaire()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getQuestionnaire', []);
