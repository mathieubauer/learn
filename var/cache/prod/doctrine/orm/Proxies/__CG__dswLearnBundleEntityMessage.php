 ...
 */
class Message extends \dsw\LearnBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Message' . "\0" . 'content', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Message' . "\0" . 'date', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Message' . "\0" . 'user', '' . "\0" . 'dsw\\LearnBundle\\Entity\\Message' . "\0" . 'module'];
        }
