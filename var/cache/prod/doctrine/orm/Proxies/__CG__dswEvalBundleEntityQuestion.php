 ...
 */
class Question extends \dsw\EvalBundle\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Question' . "\0" . 'id', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Question' . "\0" . 'intitule', '' . "\0" . 'dsw\\EvalBundle\\Entity\\Question' . "\0" . 'theme'];
        }
