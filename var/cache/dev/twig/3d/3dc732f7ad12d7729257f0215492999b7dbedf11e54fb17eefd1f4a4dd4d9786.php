...
class __TwigTemplate_6ddae36d3d48e2ebb1d69dbc110cd8d73b7e3640b7ec2b190818e4170459dba0 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "dswAmpliBundle:Espace:add.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "dswAmpliBundle:Espace:add.html.twig"));
    ...
    ";
        ...
        ";
        // line 26
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "categories", array()), 'label', array("label" => "Catégories"));
        echo "
        <div class=\"categories\" data-prototype=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Bridge\Twig\Form\TwigRenderer')->searchAndRenderBlock($this->getAttribute($this->getAttribute($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "categories", array()), "vars", array()), "prototype", array()), 'widget'), "html_attr");
        echo "\">
            ";
        // line 28
...
";
    ...
    {
        return array (  151 => 35,  145 => 31,  136 => 29,  132 => 28,  128 => 27,  124 => 26,  118 => 23,  111 => 19,  104 => 15,  98 => 12,  93 => 10,  87 => 6,  78 => 5,  61 => 3,  42 => 2,  11 => 1,);
    }
...
{% block title %}{{ parent() }} - Ajouter un espace{% endblock %}
...
<div class=\"container my-5\">
    ...
    {{ form_start(form) }}
        ...
        <div class=\"mb-3\">
        {{ form_widget(form.animateur) }}
        </div>

        {{ form_label(form.categories, 'Catégories') }}
        <div class=\"categories\" data-prototype=\"{{ form_widget(form.categories.vars.prototype)|e('html_attr') }}\">
            {% for categorie in form.categories %}
                {{ form_widget(categorie.titre) }}
            {% endfor %}
        </div>
...
{% endblock %}", "dswAmpliBundle:Espace:add.html.twig", "/Users/mbr/Documents/a_MAMP/ampli_symfony/src/dsw/AmpliBundle/Resources/views/Espace/add.html.twig");
    }
}
