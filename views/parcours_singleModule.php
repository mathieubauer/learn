...
<div class="card fil">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
        Vous allez supprimer le message :
        <?= $message->getMessage(); ?>.
        <br>Cette action est irréversible. Êtes-vous sûr ?
        </div>
    ...
    <textarea class="form-control" rows="2" name="message" id="chat_message" placeholder="Votre message"></textarea>
    <br>
