...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('dswAmpliBundle:Admin:index.html.twig', array(
    ...
    public function userAction()
    {
        ...
        $users = $em->getRepository('dswUserBundle:User')->findBy(
            array(),
            array('lastLogin' => 'DESC')
        );
    ...
    public function configAction(Request $request)
    {
        ...
        // $em = $this->getDoctrine()->getManager();
        $configs = array('configs' => $this->getDoctrine()->getRepository('dswAmpliBundle:Config')->findAll()) ;
        ...
        if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
            ...
            return $this->redirectToRoute('dsw_ampli_admin_config');
            
        }

        return $this->render('dswAmpliBundle:Admin:config.html.twig', array(
          'configs' => $configs,
          'form' => $form->createView(),
        ));
